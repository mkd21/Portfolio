...
export default function LandingPage() {
    return (
        <div className=" xs400:pt-[3rem] xl:pt-0 relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100
            xl:h-[30rem] ">
            {/* Background Pattern */}
            ...
            <div className="relative z-10">
                <header className=" xs400:w-[80%] xs400:m-auto xl:w-[100%] xl:flex xl:justify-around xl:items-center xl:pt-[3rem]">
                    <section className="xs400:mb-12 xl:mb-0 xs400:w-[67%] xl:w-[33%] ">
                        <section className=" xs400:mb-4 ">
                            <h1 className=" xs400:text-[2.2rem] xs400:mb-2 xl:text-[4rem] xl:font-[700] text-gray-800" style={{fontWeight: "600",textShadow: "rgb(21 76 160) 14px 12px 45px" }}>
                                Mayank Deep
                            </h1>
                            <h2 className="text-blue-600 font-[600] xs400:text-[1.3rem] xl:text-[1.6rem]" style={{textShadow: "0 0 30px #e950d2"}} >Full Stack Developer</h2>
                        </section>

                        {/* location and contact number */}
                        <section className="font-[600] xs400:text-[1.2rem] xl:text-[1.6rem] xl:mt-[0.7rem] xl:mb-[2rem]">
                            <h2 style={{ "display": "inline" }} className=" xs400:mr-4 xl:mr-8 xl:me-[2rem]">
                        ...
                        {/* links */}
                        <section className="flex justify-between xs400:w-[160%] xs400:mt-4 xl:w-[100%] ">
                            {/* email */}
                    ...
                    <div className="xs400:w-[28%] xs400:absolute xs400:top-0 xs400:left-[67%] xl:relative xl:left-0 xl:w-[30%] xl:min-h-[48vh]">
                        <Tilt
                            tiltMaxAngleX={25}
                            tiltMaxAngleY={25}
                            glareEnable={false}
                        ...
                        >
                            <div className=" xs400:h-[13vh] xl:w-[100%] xl:block xl:h-[48vh] rounded-full bg-gray-900 bg-[url('../../assets/dev-image/my-image.jpg')] bg-cover bg-center border-4 border-white shadow-2xl relative">
