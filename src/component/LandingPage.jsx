            ...
            <div className="relative z-10">
                <header className=" xs360:w-[80%] xs360:m-auto xs400:w-[80%] xs400:m-auto xl:w-[100%] xl:flex xl:justify-around xl:items-center xl:pt-[3rem]">
                    <section className=" xs360:mb-12 xs400:mb-12 xl:mb-0 xs400:w-[67%] xl:w-[33%] ">
                        ...
                        {/* links */}
                        <section className="flex justify-between xs360:w-[100%] xs360:text-[0.8rem] xs360:mt-8 xs400:w-[160%] xs400:text-[1.1rem] xs400:mt-4 xl:w-[100%] ">
                            {/* email */}
                    ...
                    <div className=" xs360:w-[27%] xs360:absolute xs360:top-[31px] xs360:left-[68%] xs400:w-[28%] xs400:absolute xs400:top-0 xs400:left-[67%] xl:relative xl:left-0 xl:w-[30%] xl:min-h-[48vh]">
                        <Tilt
                            tiltMaxAngleX={25}
                            tiltMaxAngleY={25}
                            glareEnable={false}
